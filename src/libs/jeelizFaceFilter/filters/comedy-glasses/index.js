"use strict";
import * as JEEFACEFILTERAPI from "../../index";
import THREE from "../../three_js/matrix";
import "./style.css";
...
function main(divElement, canvasId, NNCpath, video){
  DIV=divElement;
  if (!DIV){
    alert('ERROR : You should have a div with "comedy-glass.png" element in the DOM. Abort.');
    return;
  }
